...
class RejectReceivedApplicationTestSuite(ModelValidationTestCase):
    def setUp(self):
    ...
    def test_reject_received_thread_application_as_thread_owner(self):
        # actor1 rejects received thread application
        ...
        self.assertEqual(thread_application_model.status, 3)
